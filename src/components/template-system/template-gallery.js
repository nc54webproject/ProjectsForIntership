...
const CHATBOT_TEMPLATES = [
  {
    ...
    name: 'Customer Support Bot',
    description:
      'Handle common customer inquiries and route to human agents when needed',
    category: 'Support',
    difficulty: 'Beginner',
    preview: 'Welcome! How can I help you today?',
    nodes: [
...
=======
  ...
  },
  {
    ...
    name: 'Lead Generation Bot',
    description:
      'Qualify leads and collect contact information for sales follow-up',
    category: 'Sales',
    difficulty: 'Intermediate',
>>>>>>> e642b62 (new nodes and flow improvement)
    rating: 4.6,
...
=======
        ...
        data: {
          label: 'Welcome',
          message:
            "Hi! I'm here to help you find the perfect solution for your business. Let's get started!",
        },
      },
      {
        id: 'company-size',
...
=======
      ...
      },
      {
        ...
        data: {
          label: 'Thank You',
          message:
            'Thank you! Our sales team will contact you within 24 hours with a personalized proposal.',
>>>>>>> e642b62 (new nodes and flow improvement)
        },
      },
    ],
    ...
    nodes: [
      {
        ...
        data: {
          label: 'Event Welcome',
          message:
            "Welcome! Ready to register for our upcoming Tech Conference 2024? It'll just take a minute!",
        },
      },
      {
        id: 'event-interest',
...
=======
        ...
        data: {
          label: 'Confirmation',
          message:
            "🎉 You're registered! Check your email for the confirmation and event details. See you there!",
>>>>>>> e642b62 (new nodes and flow improvement)
        },
      },
    ],
    ...
    nodes: [
      {
        ...
        data: {
          label: 'Survey Intro',
          message:
            "Hi! We'd love to hear about your experience with us. This quick survey takes just 2 minutes.",
        },
      },
      {
        id: 'satisfaction',
      ...
      },
      {
        ...
        data: {
          label: 'Improvement Suggestions',
          prompt:
            "We're sorry to hear that. What can we do to improve your experience?",
          inputType: 'text',
          variable: 'improvement_suggestions',
>>>>>>> e642b62 (new nodes and flow improvement)
          required: false,
...
=======
        ...
        data: {
          label: 'Final Thanks',
          message:
            'Thank you for taking the time to share your feedback. It helps us serve you better!',
>>>>>>> e642b62 (new nodes and flow improvement)
        },
      },
    ],
...
=======
                <span
                  className={`difficulty ${previewTemplate.difficulty.toLowerCase()}`}
                >
>>>>>>> e642b62 (new nodes and flow improvement)
...
=======
                ...
                <div className="template-preview">
                  <div className="preview-message">
                    <div className="message-bubble">{template.preview}</div>
>>>>>>> e642b62 (new nodes and flow improvement)
                  </div>
                </div>
